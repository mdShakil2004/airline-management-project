...
function Hero(){
  ...
  return(
    <div className='hero-section bg-gradient-to-r from-blue-200 to-slate-300'>
    ...
    <svg className="hidden xl:inline absolute w-2/3 ml-[8rem] mt-[18rem] -rotate-[20deg] z-0" xmlns="http://www.w3.org/2000/svg" width="1414" height="319" viewBox="0 0 1414 319" fill="none">
      ...
      <div className='w-screen md:max-w-[20rem] lg:pt-[5rem] z-10'>
        ...
        <button 
  className="inline text-white rounded text-xl mt-6 font-bold p-2 sm:w-[8rem] transition duration-500 ease-in-out bg-blue-600 hover:bg-slate-300 hover:text-black transform hover:-translate-y-1 hover:scale-110 ..."
  onClick={() => window.location.href = '/view_flights'}
>
  Book Now
</button>
      ...
      <div className='flex flex-row mx-auto md:flex-grow'>
        <div className='flex md:my-auto lg:my-0'>
          <motion.div style={{
            ...
            className=' w-[22rem] sm:w-[30rem]  md:w-full hover:z-[300px] hover:scale-105 duration-1000 z-50' src='/plane.png' alt=''></img>
          </motion.div> 
        </div>
